...
const HeroSection = () => {
  return (
    <div className=" video_section flex justify-center items-center relative top-[365px] z-[-10000] md:mt-[90px] mt-[-80px]">

          <video className="opacity-35 w-[90%]  rounded-[30px] z-[-500] absolute" autoPlay loop playsInline muted >
